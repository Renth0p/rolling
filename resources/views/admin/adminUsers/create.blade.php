...
@section('content')
    <div class="container mx-auto px-6 py-8">
        ...
        <div class="mt-8">
            <form enctype="multipart/form-data" class="space-y-5 mt-5" method="POST" action="{{ isset($user) ? route("admin.adminUsers.update", $user->id) : route("admin.adminUsers.store") }}">
                @csrf
